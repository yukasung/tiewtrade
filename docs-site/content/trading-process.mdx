...
sequenceDiagram
    ...
    B->>T: Replace target using latest ATR
    T->>E: Exit execution request
    E->>B: Take Profit Fill
...
แผนภาพแสดงว่า Basket เปลี่ยนหลังได้รับ Fill จริงเท่านั้น ทุก Entry Fill ทำให้ weighted average และ Take Profit ถูกคำนวณใหม่ เมื่อ exit Fill สำเร็จ Entries ทั้งหมดปิดพร้อมกันและ Basket ใหม่เริ่มได้ทันที
