...
ข้อมูลตลาดต้องต่อเนื่องและไม่ซ้ำก่อนถึง Strategy เมื่อเกิดสัญญาณ ระบบยังต้องผ่าน capital, Entry Pair, Cooldown Month และ safety policies ก่อนเรียก execution adapter ทุกผลลัพธ์สำคัญผูกกับ Bot Session โดยตรงเพื่ออธิบายย้อนหลังได้
