...
State diagram นี้แยก warm-up, reset, confirmation และการรอ Fill เพื่อให้เห็นว่าแต่ละ signal ถูกใช้เพียงครั้งเดียว
...
Confirmation ต้องเกิดใน completed Candle เดียวกันและผ่านทุกเงื่อนไข: RSI สูงกว่า 50, `close > open`, `close > reset close`, Basket ยังไม่ครบ `max_entries` ของ Session และ Bot Session กับ lifecycle อนุญาต Entry ใหม่
