...
จาก tracer slice นี้จึงกำหนด Account Profile และ Session ownership ก่อนบันทึก ownership เดียวกันด้วย SQLite จากนั้นเติม public market-data runtime, Paper Futures, desktop UI และ restart Recovery ตามลำดับ dependency จนครบ flow ใช้งานจริง ไม่ถือว่าการ replay ชุดเดียวสำเร็จเท่ากับ Paper Trading Complete
