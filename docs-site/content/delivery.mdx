---
title: Delivery
description: ลำดับ vertical slices และ quality gates ของ TiewTrade V2
---
...
Paper เริ่มจาก vertical slice ของ BTCUSDT Spot: รับ completed Candles ที่ต่อเนื่อง, คำนวณ Wilder RSI/ATR, สร้าง deterministic Entry Intent, บังคับ Spot 80/20 และ Entry Pair, Fill ที่ Candle ถัดไป, ปิด Basket ด้วย Take Profit และ replay ผลเดิม
