...
Internal Alpha ไม่มี automatic Stop Loss หรือ loss limits ระบบแสดง PnL, Drawdown และ notification แต่ยังบังคับ capital allocation, 10 Entries และ Futures leverage cap เสมอ Stop Session หยุด Entry ใหม่และบันทึก state โดยไม่บังคับปิด Basket
