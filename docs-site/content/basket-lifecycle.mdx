...
Basket รวม Entries ของรอบการสะสม Position เดียวกันและมี Take Profit ร่วมกัน Basket หนึ่งมีได้สูงสุดตาม `max_entries` ของ immutable Session policy ทุกการคำนวณอ้างอิง Fill ที่ยืนยันแล้ว ไม่ใช้เพียง Order หรือ Entry Intent
...
ค่าธรรมเนียมไม่ถูกบวกใน Take Profit price แต่ entry fees และ exit fees ต้องถูกหักเมื่อคำนวณ realized PnL สำหรับ Paper Futures Phase แรก Funding Fee เป็น `0.00`; Live Futures ในอนาคตต้องใช้ funding ที่เกิดขึ้นจริงจาก Binance
