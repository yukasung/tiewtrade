...
`SessionConfig` เป็น configuration แบบ immutable ที่ระบุ session, Account Profile, Preset version, Market Type, Trade Mode, Available Capital, `EntryPolicy`, market-specific capital policy, fee และ slippage
