...
5. วน lifecycle นี้จน Basket ปิดหรือครบสูงสุด 10 Entries
6. การปิด Basket จะ reset Entry Pair และ Cooldown state สำหรับ Basket ใหม่

## 7. Capital Allocation

ผู้ใช้กำหนด Available Capital สำหรับแต่ละ Session ระบบแบ่งขนาด Entry ทั้ง 10 ไม้เท่ากันจาก Trading Capital ของ Mode นั้น

### 7.1 Spot

- Trading Capital: 80% ของ Available Capital
- Spot Reserve: 20% ของ Available Capital
- Quote notional ต่อ Entry: Trading Capital หาร 10
...
- Initial margin budget ต่อ Entry: Trading Capital หาร 10
...
ระบบต้องบังคับ capital allocation, leverage cap และขีดจำกัด 10 Entries ใน Paper และ Live ด้วยกติกาชุดเดียวกัน
